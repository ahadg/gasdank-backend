...
const NotificationSchema = new mongoose_1.Schema({
    user_id: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true }, // recipient
    actorId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User' }, // person who triggered it
